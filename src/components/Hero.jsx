  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 flex justify-start items-start flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <h1  className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full ">souls.</h1>
        ...
        <span className="text-gradient max-w-[600px] flex flex-wrap">
         ● Low Price Therapy | Community | Clubs | Anonymous chat  
        </span>
        </p>
        <div className={`${styles.flexCenter} sm:ml-80 sm:mt-0 mt-10 w-fit`}>
        <Button styles={`mt-10`} /> {/* Adjust the margin to move the button more to the right */}
        </div>
      </div>
